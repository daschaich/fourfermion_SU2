...
/* uncompresses an anti_hermitian su2 matrix */
	...
	//mat_su2->e[2][2].imag=mat_antihermit->m22im;
	//mat_su2->e[2][2].real=0.;
	...
	//mat_su2->e[0][2].imag=mat_antihermit->m02.imag;
	//temp1=mat_antihermit->m02.real;
	//mat_su2->e[0][2].real=temp1;
	//mat_su2->e[2][0].real= -temp1;
	//mat_su2->e[2][0].imag=mat_antihermit->m02.imag;
	//mat_su2->e[1][2].imag=mat_antihermit->m12.imag;
	//temp1=mat_antihermit->m12.real;
	//mat_su2->e[1][2].real=temp1;
	//mat_su2->e[2][1].real= -temp1;
	//mat_su2->e[2][1].imag=mat_antihermit->m12.imag;
